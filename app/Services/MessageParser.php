...
class MessageParser
{
    ...
    private const NOISE_NAME_PATTERN = '/^(?:только|лишь|либо|или|можно|нужно|если|все|всё|обмены?|торг|состав|рассмотрю|кланам|продам|продаю|куплю|покупаю|обменяю|меняю|услуги|пассивки)\b/ui';
